...
const Header = () => {
  ...
  const menuItems = [
    { icon: TrendingUp, label: "Tabla de Popularidad", path: "/leaderboard" },
    { icon: Bookmark, label: "Guardados", path: "/saved" },
    { icon: Settings, label: "Configuración y privacidad", path: "/settings" },
    { icon: Monitor, label: "Pantalla y accesibilidad", path: "/settings/accessibility" },
  ];

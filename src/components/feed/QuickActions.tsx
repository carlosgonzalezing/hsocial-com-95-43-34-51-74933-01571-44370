...
export function QuickActions() {
  ...
  return (
    <Card className="p-4 mb-4 border border-border/60 bg-card shadow-sm">
        ...
        {actions.map((action) => (
          ...
          >
            <div className="flex flex-col items-center gap-2 p-3 rounded-xl hover:bg-muted/50 transition-all">
              <div className={`w-12 h-12 rounded-xl ${action.color} ${action.hoverColor} flex items-center justify-center transition-colors duration-200`}>
